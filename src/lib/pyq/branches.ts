...
export const SUBJECT_REGISTRY: Record<string, PYQSubject[]> = {
  CS: [
    ...
    },
    {
      ...
      displayOrder: 10,
      topics: [
        { topicName: "Algorithms", displayName: "Algorithms", displayOrder: 1, subtopics: ["Graph Algorithms", "Sorting", "Dynamic Programming", "Greedy"], questionCount: 100 },
        { topicName: "Data Structures", displayName: "Data Structures", displayOrder: 2, subtopics: ["Arrays", "Linked Lists", "Trees", "Graphs"], questionCount: 80 },
        { topicName: "Programming", displayName: "Programming", displayOrder: 3, subtopics: ["C/Java/Python", "Pointers", "Recursion"], questionCount: 60 },
        { topicName: "Digital Logic", displayName: "Digital Logic", displayOrder: 4, subtopics: ["Boolean Algebra", "Combinational", "Sequential"], questionCount: 50 },
        { topicName: "Computer Organization", displayName: "Computer Organization", displayOrder: 5, subtopics: ["ALU", "Memory", "Pipelining"], questionCount: 70 },
        { topicName: "Operating Systems", displayName: "Operating Systems", displayOrder: 6, subtopics: ["Process Management", "Memory Management", "File Systems"], questionCount: 80 },
        { topicName: "DBMS", displayName: "DBMS", displayOrder: 7, subtopics: ["SQL", "Normalization", "Transactions"], questionCount: 70 },
        { topicName: "Computer Networks", displayName: "Computer Networks", displayOrder: 8, subtopics: ["TCP/IP", "Routing", "DNS", "HTTP"], questionCount: 70 },
        { topicName: "Theory of Computation", displayName: "Theory of Computation", displayOrder: 9, subtopics: ["DFA/NFA", "CFG", "Turing Machines"], questionCount: 60 },
        { topicName: "Compiler Design", displayName: "Compiler Design", displayOrder: 10, subtopics: ["Lexical Analysis", "Parsing", "Code Generation"], questionCount: 50 },
        { topicName: "Engineering Mathematics", displayName: "Engineering Mathematics", displayOrder: 11, subtopics: ["Linear Algebra", "Calculus", "Probability", "Discrete Math"], questionCount: 80 },
        { topicName: "General Aptitude", displayName: "General Aptitude", displayOrder: 12, subtopics: ["Verbal", "Quantitative", "Reasoning"], questionCount: 100 },
      ],
    },
    {
      subjectName: "CS",
      ...
      displayOrder: 11,
      topics: [
        { topicName: "Algorithms", displayName: "Algorithms", displayOrder: 1, subtopics: ["Graph Algorithms", "Sorting", "Dynamic Programming"], questionCount: 100 },
        { topicName: "Data Structures", displayName: "Data Structures", displayOrder: 2, subtopics: ["Arrays", "Linked Lists", "Trees"], questionCount: 80 },
        { topicName: "Programming", displayName: "Programming", displayOrder: 3, subtopics: ["C/Java/Python", "Pointers", "Recursion"], questionCount: 60 },
        { topicName: "Digital Logic", displayName: "Digital Logic", displayOrder: 4, subtopics: ["Boolean Algebra", "Combinational", "Sequential"], questionCount: 50 },
        { topicName: "Computer Organization", displayName: "Computer Organization", displayOrder: 5, subtopics: ["ALU", "Memory", "Pipelining"], questionCount: 70 },
        { topicName: "Operating Systems", displayName: "Operating Systems", displayOrder: 6, subtopics: ["Process Management", "Memory Management"], questionCount: 80 },
        { topicName: "DBMS", displayName: "DBMS", displayOrder: 7, subtopics: ["SQL", "Normalization", "Transactions"], questionCount: 70 },
        { topicName: "Computer Networks", displayName: "Computer Networks", displayOrder: 8, subtopics: ["TCP/IP", "Routing", "DNS"], questionCount: 70 },
        { topicName: "Theory of Computation", displayName: "Theory of Computation", displayOrder: 9, subtopics: ["DFA/NFA", "CFG", "Turing Machines"], questionCount: 60 },
        { topicName: "Compiler Design", displayName: "Compiler Design", displayOrder: 10, subtopics: ["Lexical Analysis", "Parsing"], questionCount: 50 },
        { topicName: "Engineering Mathematics", displayName: "Engineering Mathematics", displayOrder: 11, subtopics: ["Linear Algebra", "Calculus", "Probability"], questionCount: 80 },
        { topicName: "General Aptitude", displayName: "General Aptitude", displayOrder: 12, subtopics: ["Verbal", "Quantitative", "Reasoning"], questionCount: 100 },
      ],
    },
  ],
